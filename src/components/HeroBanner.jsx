            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>ssatyaranjan125@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Satya</span>
                    </div>
                    <div className="max-w-[510px]">
                    Welcome to my world of Java development! As a full stack Java developer, I thrive on building complex applications from scratch and bringing ideas to life. I deliver innovative and intuitive solutions, Let's build something great together!
                    </div>
                </motion.div>
                {/* INTRO END */}
...
<div
    ...
    onClick={() => {
        ...
        link.href = 'https://drive.google.com/u/0/uc?id=1YrnWuZEmyXBAsXsa2MRoWDe6FXEwhfm0&export=download';
        link.download = 'Satya_Resume.pdf';
        ...
        setTimeout(() => {
            const file = new File([''], 'Satya_Resume.pdf');
...
>
    <img
        ...
        alt=""
        className="inline-block ml-2 w-[12px]"
    />
